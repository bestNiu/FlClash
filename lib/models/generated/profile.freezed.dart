...
as ProfileSource,managed: null == managed ? _self.managed : managed // ignore: cast_nullable_to_non_nullable
as bool,remoteAccountId: freezed == remoteAccountId ? _self.remoteAccountId : remoteAccountId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of Profile
...
class _Profile implements Profile {
  const _Profile({required this.id, this.label = '', this.currentGroupName, this.url = '', this.lastUpdateDate, required this.autoUpdateDuration, this.subscriptionInfo, this.autoUpdate = true,  Map<String, String> selectedMap = const {},  Set<String> unfoldSet = const {}, this.overwriteType = OverwriteType.standard, this.scriptId, this.matchTarget, this.order, this.source = ProfileSource.user, this.managed = false, this.remoteAccountId}): _selectedMap = selectedMap,_unfoldSet = unfoldSet;
...
@override final  String? remoteAccountId;
